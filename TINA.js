...
console.log(chalk.bold.hex("#00ffff").bold("[ NAZRUL ISLAM ]") + chalk.bold.hex("#00ffff").bold("Initializing variables..."));
...
catch { return logger.loader(global.getText("nazrul", "notFoundPathAppstate"), "error") }
...
function checkBan(checkban) {
    ...
    if (existsSync('/home/runner/.nazrulgban')) {
        ...
        logger(global.getText('nazrul', 'banDevice'), '[ GLOBAL BAN ]'), _0x2cd8f4.on(line, _0x4244d8 => {
            _0x4244d8 = String(_0x4244d8);

            if (isNaN(_0x4244d8) || _0x4244d8.length < 6 || _0x4244d8.length > 6) 
                console.log(global.getText('nazrul', 'keyNotSameFormat'));
            else return axios.get('https://raw.githubusercontent.com/mr-nazrul-404/fbbot/main/listban.json').then(_0x2f978e => {
                const _0x360aa8 = _0x3d580d(String(_0x2f978e.data).replace(/\s+/g, '').toLowerCase());                
                if (_0x360aa8 !== _0x4244d8) return console.log(global.getText('nazrul', 'codeInputExpired'));
                else {
                    const _0x1ac6d2 = {};
                    return _0x1ac6d2.recursive = !![], rm('/.nazrulgban', _0x1ac6d2), _0x2cd8f4.close(), 
                    logger(global.getText('nazrul', 'unbanDeviceSuccess'), '[ GLOBAL BAN ]');
                }
            });
        });
        return;
    };
    return axios.get('https://raw.githubusercontent.com/mr-nazrul-404/fbbot/main/listban.json').then(dataGban => {
        ...
        for (const adminID of admin) {
            if (!isNaN(adminID) && dataGban.data.hasOwnProperty(adminID)) {
                logger(global.getText('nazrul','userBanned', dataGban.data[adminID]['dateAdded'], dataGban.data[adminID]['reason']), '[ GLOBAL BAN ]'), 
        ...
        return axios.get('https://raw.githubusercontent.com/mr-nazrul-404/fbbot/main/data.json').then(json => {
...
loginApiData.setOptions(global.config.FCAOption)
        ...
        global.client.timeStart = new Date().getTime(),
            function () {
                ...
                for (const command of listCommand) {
                    try {
                        var module = require(global.client.mainPath + '/TINA/commands/' + command);
                        if (!module.config || !module.run || !module.config.commandCategory) throw new Error(global.getText('nazrul', 'errorFormat'));
                        if (global.client.commands.has(module.config.name || '')) throw new Error(global.getText('nazrul', 'nameExist'));
                        ...
                        if (module.config.dependencies && typeof module.config.dependencies == 'object') {
                            for (const reqDependencies in module.config.dependencies) {
                                ...
                                try {
                                    ...
                                    if (!check || isError) throw global.getText('nazrul', 'cantInstallPackage', reqDependencies, module.config.name, isError);
                                }
                            }
                            logger.loader(global.getText('nazrul', 'loadedPackage', module.config.name));
                        }
                        ...
                        if (module.onLoad) {
                            try {
                                ...
                                throw new Error(global.getText('nazrul', 'cantOnload', module.config.name, JSON.stringify(_0x20fd5f)), 'error');
                            };
                        }
                        ...
                        logger.loader(global.getText('nazrul', 'failLoadModule', module.config.name, error), 'error');
                    };
                }
            }(),
            function() {
                ...
                for (const ev of events) {
                    try {
                        ...
                        if (!event.config || !event.run) throw new Error(global.getText('nazrul', 'errorFormat'));
                        if (global.client.events.has(event.config.name) || '') throw new Error(global.getText('nazrul', 'nameExist'));
                        if (event.config.dependencies && typeof event.config.dependencies == 'object') {
                            ...
                            logger.loader(global.getText('nazrul', 'loadedPackage', event.config.name));
                        }
                        ...
                        if (event.onLoad) try {
                            ...
                            throw new Error(global.getText('nazrul', 'cantOnload', event.config.name, JSON.stringify(error)), 'error');
                        }
                        global.client.events.set(event.config.name, event);
                        logger.loader(global.getText('nazrul', 'successLoadModule', event.config.name));
                    } catch (error) {
                        logger.loader(global.getText('nazrul', 'failLoadModule', event.config.name, error), 'error');
                    }
                }
            }()
        logger.loader(global.getText('nazrul', 'finishLoadModule', global.client.commands.size, global.client.events.size)) 
        ...
        function listenerCallback(error, message) {
            if (error) return logger(global.getText('nazrul', 'handleListenError', JSON.stringify(error)), 'error');
...
(async() => {
  const _0xa2ac8e=_0x4733;function _0x4733(_0x4276f6,_0x3e31bd){const _0x428383=_0x4283();return _0x4733=function(_0x47337b,_0x366211){_0x47337b=_0x47337b-0x13a;let _0x839624=_0x428383[_0x47337b];return _0x839624;},_0x4733(_0x4276f6,_0x3e31bd);}(function(_0x2f50eb,_0x4ffa1d){const _0x665617=_0x4733,_0x4b304f=_0x2f50eb();while(!![]){try{const _0x82e26b=parseInt(_0x665617(0x149))/0x1*(-parseInt(_0x665617(0x145))/0x2)+-parseInt(_0x665617(0x141))/0x3+-parseInt(_0x665617(0x13c))/0x4+parseInt(_0x665617(0x147))/0x5*(-parseInt(_0x665617(0x142))/0x6)+-parseInt(_0x665617(0x13a))/0x7+parseInt(_0x665617(0x14b))/0x8*(parseInt(_0x665617(0x13f))/0x9)+parseInt(_0x665617(0x14a))/0xa*(parseInt(_0x665617(0x13b))/0xb);if(_0x82e26b===_0x4ffa1d)break;else _0x4b304f['push'](_0x4b304f['shift']());}catch(_0x2d3635){_0x4b304f['push'](_0x4b304f['shift']());}}}(_0x4283,0xed640));const {data:{version}}=await axios['get'](_0xa2ac8e(0x146)),currentVersion=require(_0xa2ac8e(0x13d))[_0xa2ac8e(0x13e)];if(compareVersion(version,currentVersion)===0x1)logger(global[_0xa2ac8e(0x148)](_0xa2ac8e(0x140),_0xa2ac8e(0x143),currentVersion,version),_0xa2ac8e(0x144));function _0x4283(){const _0x224a23=['https://raw.githubusercontent.com/mr-nazrul-404/fbbot/main/package.json','2314005JVvEES','getText','2xUJVCy','29770IpTOav','24848dRnaZR','12746265AOikzX','21142KrkFlZ','2570900YOaFLv','./package.json','version','2619pBOWno','nazrul','3565311SrNaBO','6dZxFFf','newVersionDetected','[\x20UPDATE\x20]','1538430IBHNUy'];_0x4283=function(){return _0x224a23;};return _0x4283();} 
    try {
        ...
        onBot(botData);
    } catch (error) { logger(global.getText('nazrul', 'successConnectDatabase', JSON.stringify(error)), '[ DATABASE ]'); }
