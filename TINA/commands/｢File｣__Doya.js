...
module.exports.run = () => {
  ...
  let dirMaterial = __dirname + `/cyber/doya/`; 
  if (!existsSync(dirMaterial + "cyber" + "12doya")) mkdirSync(dirMaterial, { recursive: true });
  ...
  let { threadID, messageID, senderID, body } = event;
    switch(handleReply.type) {
      ...
      api.sendMessage({
        ...
        attachment: createReadStream(__dirname + `/cyber/doya/doya1.jpg`)
      }, threadID, messageID);
      break;
    ...
    case "2":
      ...
      api.sendMessage({
        ...
        attachment: createReadStream(__dirname + `/cyber/doya/doya2.jpg`)
      },threadID, messageID);
      break;
    ...
    case "3":
      ...
      api.sendMessage({
        ...
        attachment: createReadStream(__dirname + `/cyber/doya/doya3.jpg`)
      }, threadID, messageID); 
      break;
    ...
    case "4":
      ...
      api.sendMessage({
        ...
        attachment: createReadStream(__dirname + `/cyber/doya/doya4.jpg`)
      }, threadID, messageID); 
      break;
    ...
    case "5":
      ...
      api.sendMessage({
        ...
        attachment: createReadStream(__dirname + `/cyber/doya/doya5.jpg`)
      }, threadID, messageID); 
      break;
