...
module.exports.run = async function ({ event, args, api }) {
  ...
  return api.sendMessage({body: `╭╺╺╺╺╺╺╺╺╺╺╺╺╺╺╺╺╺╺╺◈┊┌⟝⟢ 『 𝗬𝗢𝗨𝗥 𝗔𝗚𝗢 』 ⟣⟞┊│╭─────────────···◈┊┴│┊༆│✿ *ᴅᴀᴛᴇ ᴏғ ʙɪʀᴛʜ* : *${input}*┊༆│✿ *ʏᴏᴜʀ ᴀɢᴇ* : *${nam}*┊༆│⟝────────────---◈┊༆│✿ *ᴍᴏɴᴛʜ* : *${thang}*┊༆│✿ *ᴡᴇᴇᴋ* : *${tuan}*┊༆│✿ *ᴅᴀʏ* : *${ngay}*┊༆│✿ *ʜᴏᴜʀs* : *${gio}*┊༆│✿ *ᴍɪɴᴜᴛᴇs* : *${phut}* ┊༆│✿ *sᴄᴇ* :*${giay}*┊༆│▸𝐈𝐬𝐥𝐚𝐦𝐢𝐜𝐤 𝐂𝐲𝐛𝐞𝐫 𝐂𝐡𝐚𝐭┬  ││  ╰───────────---◈└────────────────···◈`, attachment: await streamURL(`https://graph.facebook.com/${event.senderID}/picture?height=720&width=720&access_token=6628568379%7Cc1e620fa708a1d5696fb991c1bde5662`)},event.threadID,event.messageID);
	  }
